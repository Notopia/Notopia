...
function changeSelectHandler() {
    ...
    if (select1.value == "Koromatic") {
        ...
        if (select2.value == "Tabi'i") {
            ...
            if (select3.value == "Major") {
                text1.innerText = "برای بدست آوردن نوع هارمونیک گام های ماژور ، بایستی از درجه ششم گام ، ( نت ششم گام ) نیم پرده کروماتیک کم شود ( اگر علامت درجه ششم ، دیز : دوبل دیز ، بکار : دیز ، بمل : بکار ، دوبل بمل : بمل  )"
            }
            else if (select3.value == "Minor") {
                text1.innerText = "برای بدست آوردن نوع هارمونیک گام های مینور ، بایستی به درجه هفتم گام ، ( نت هفتم گام ) نیم پرده کروماتیک اضافه کنیم ( اگر علامت درجه هفتم  ، دوبل دیز : دیز ، دیز: بکار ، بکار: بمل ، بمل : دوبل بمل  )"
            }
